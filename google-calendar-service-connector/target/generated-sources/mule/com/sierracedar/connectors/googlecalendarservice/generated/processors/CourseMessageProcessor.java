...
/**
 * CourseMessageProcessor invokes the {@link com.sierracedar.connectors.googlecalendarservice.GoogleCalendarServiceConnector#course(java.lang.String)} method in {@link GoogleCalendarServiceConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements MessageProcessor, OperationMetaDataEnabled
{
    ...
    public CourseMessageProcessor(String operationName) {
        super(operationName);
    }
        ...
        throws Exception
    {
        ...
        try {
            ...
            final String _transformedCalendarId = ((String) evaluateAndTransform(getMuleContext(), event, CourseMessageProcessor.class.getDeclaredField("_calendarIdType").getGenericType(), null, calendarId));
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                {
                    try {
                        return ((GoogleCalendarServiceConnector) object).course(_transformedCalendarId);
                    } catch (Exception e) {
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleCalendarServiceConnector at course retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
