...
public class DataSenseResolver {
     ...
     */
    @Inject
    private GoogleCalendarImpersonateConnector connector;
    ...
    public GoogleCalendarImpersonateConnector getConnector() {
        return connector;
    }

    public void setConnector(GoogleCalendarImpersonateConnector connector) {
